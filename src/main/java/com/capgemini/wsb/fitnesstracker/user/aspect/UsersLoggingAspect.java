package com.capgemini.wsb.fitnesstracker.user.aspect;
...
public class UsersLoggingAspect {
    private static final Logger logger = LoggerFactory.getLogger(UsersLoggingAspect.class);

    @Before("execution(* com.capgemini.wsb.fitnesstracker.user.internal.*.*(..))")
